# Google Cloud Client Libraries for Swift - Cloud Data Fusion API
...
Add `swift-google-cloud-datafusion-v1` as a package dependency:

```bash
swift package add-dependency https://github.com/googleapis/swift-google-cloud-datafusion-v1.git --from 0.1.0-preview
```

Then add `GoogleCloudDataFusionV1` to your target's dependencies:

```bash
swift package add-target-dependency GoogleCloudDataFusionV1 <target-name> --package swift-google-cloud-datafusion-v1
```
